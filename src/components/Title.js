        ...
        <div className="row py-3">
            <div className="col-12 col-md-6 justify-content-center py-5">
                ...
                <Link to="/register">
                 ...
                 <button type="submit"className="btn btn-outline-success rounded-pill h1"style={{backgroundColor:"green",color:"white"}}>
                 <h2>
                 Register&nbsp;
                 
<i className="fa fa-angle-double-right h-1" aria-hidden="true"></i>
</h2>
                        </button></Link>
